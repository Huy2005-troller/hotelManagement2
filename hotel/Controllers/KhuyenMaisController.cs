...
namespace hotel.Controllers
{
    public class KhuyenMaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ten,MoTa,PhanTramGiam")] KhuyenMai khuyenMai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ten,MoTa,PhanTramGiam")] KhuyenMai khuyenMai)
        {
            if (id != khuyenMai.Id)
            {
                return NotFound();
