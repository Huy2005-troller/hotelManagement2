        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckinCheckouts_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                name: "CheckinCheckoutDetails",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CheckinCheckoutId = table.Column<int>(type: "int", nullable: false),
                    TenKhach = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CCCD = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DichVuId = table.Column<int>(type: "int", nullable: true),
                    DonGiaDichVu = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckinCheckoutDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CheckinCheckoutDetails_CheckinCheckouts_CheckinCheckoutId",
                        column: x => x.CheckinCheckoutId,
                        principalTable: "CheckinCheckouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CheckinCheckoutDetails_DichVus_DichVuId",
                        column: x => x.DichVuId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckinCheckoutDetails_CheckinCheckoutId",
                table: "CheckinCheckoutDetails",
                column: "CheckinCheckoutId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckinCheckoutDetails_DichVuId",
                table: "CheckinCheckoutDetails",
                column: "DichVuId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckinCheckouts_RoomId",
